...
{
    using Action = void(TransformManager::*)(const std::shared_ptr<BaseObject> &object, Transform &mtr);
public:
    TransformModels(const std::shared_ptr<Composite> objects, Transform &mtr);
