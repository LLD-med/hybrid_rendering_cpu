...
void ModelsCommand::setAdapter()
{
    auto adapter = std::make_shared<CompositeTransformAdapter>();
...
TransformModels::TransformModels(const std::shared_ptr<Composite> objects, Transform &mtr) :
